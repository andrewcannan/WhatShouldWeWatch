...
const LogoNav = () => {
    ...
    return (
        <nav className="navbar fixed-top" style={{backgroundColor: '#000', justifyContent: 'center', alignItems: 'center'}}>
            <div className="navbar-brand d-flex align-items-center" style={{ fontFamily: 'Montserrat', marginLeft: '5px', color: '#be1423', fontSize: '3vh', fontWeight: '600' }} onClick={handleClick}>
